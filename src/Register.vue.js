  ...
  template: `
    <div class="column col-6 col-lg-8 col-md-12 col-sm-12 col-mx-auto">
      <div class="empty">
        ...
        <p class="empty-title h5">Register</p>
        ...
        <div class="form-group">
          <button class="btn btn-primary input-group-btn" v-on:click="register" :disabled="loading">
            Register
          </button>
...
methods: {
  async register() {
    this.error = ''
      ...
      try {
        const content = await request('auth/register', 'POST', payload)
